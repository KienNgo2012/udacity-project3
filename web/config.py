...
class BaseConfig:
    DEBUG = True
    POSTGRES_URL="project3-kiennt-dbsever.postgres.database.azure.com"  #TODO: Update value #DONE
    POSTGRES_USER="project3kiennt@project3-kiennt-dbsever" #TODO: Update value #DONE
